...
class BuildTargetWeightsTests(unittest.TestCase):
    ...
    def test_valid_writes_weight_only_json(self):
        ...
        ok = mi.build_target_weights(
            held, data, s_data, mi.HELD_OK, mi.STATS_OK,
            {"069500": 10000.0, "QQQ": 500.25},
        )
        self.assertTrue(ok)
        ...
        self.assertEqual(tks["QQQ"]["ref_price"], 500.25)
        self.assertEqual(tks["QQQ"]["ref_price_source"], "generated_close")
        datetime.fromisoformat(tks["QQQ"]["ref_price_time"])
